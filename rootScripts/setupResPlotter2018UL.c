{
  ...
  std::vector<double> etBins = {5,10,15,30,50,100,150,300};
  ...
  std::vector<double> etBins32AndUp = {32,300};
  std::vector<double> absEtaBins = {0.0,1.0,1.4442,1.566,2.0,2.5};
  ...
  std::string inputDirectory = "/home/hep/wrtabb/Egamma/input_trees/2018UL/";

  //2018UL Electrons 
  std::string resultsEle = resultsDirectory + "2018UL/";
  std::string step1InputName = "DoubleElectron_FlatPt-1To300_2018ConditionsFlatPU0to70ECALGT_105X_realistic_IdealEcalIC_v2-v2.root";
  std::string step1Name = "regEleEcal2018UL_IdealIC_IdealTraining_stdVar_stdCuts_ntrees1500_applied.root"; 
  std::string step2Name = "regEleEcal2018UL_RealIC_IdealTraining_stdVar_stdCuts_ntrees1500_applied.root";
  std::string step3Name = "regEleEcal2018UL_RealIC_RealTraining_stdVar_stdCuts_ntrees1500_applied.root";
  std::string step4Name = "regEleEcalTrk2018UL_RealIC_stdVar_stdCuts_ntrees1500_applied.root";
