...
void plot(bool etaPlot, bool puPlot, bool ePlot,bool dcbFit)
{
 ...
 if(etaPlot){
  ...
  gROOT->ProcessLine("res.printFits({1,2,4},\"../plots/PFRechit/baseVs34Sigma/DCB_Eta_\")");
 }
 ...
 if(puPlot){
  ...
  gROOT->ProcessLine("res.printFits({1,2,4},\"../plots/PFRechit/baseVs34Sigma/DCB_PU_EB_\")");
  ...
  gROOT->ProcessLine("res.printFits({1,2,4},\"../plots/PFRechit/baseVs34Sigma/DCB_PU_EE_\")");
 }
 ...
 if(ePlot){
  ...
  gROOT->ProcessLine("res.printFits({1,2,4},\"../plots/PFRechit/baseVs34Sigma/DCB_Et_EB_\")");
  ...
  gROOT->ProcessLine("res.printFits({1,2,4},\"../plots/PFRechit/baseVs34Sigma/DCB_Et_EE_\")");
 }
}
